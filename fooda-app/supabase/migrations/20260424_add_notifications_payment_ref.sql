-- Add notifications table and payment_reference column to orders
...
-- ── Policies ─────────────────────────────────────────────────────────
DROP POLICY IF EXISTS "allow_own_notifications"    ON notifications;
DROP POLICY IF EXISTS "allow_vendor_notifications" ON notifications;
DROP POLICY IF EXISTS "allow_admin_notifications"  ON notifications;
...
-- ── Orders: payment_reference column ─────────────────────────────────
